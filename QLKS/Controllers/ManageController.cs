...
namespace QLKS.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpGet]
        [ActionName("SửaThôngTinTàiKhoản")]
        ...
        public ActionResult Create()
        {
            ...
            foreach (var item in db.NVs)
            {
                ...
                ViewBag.MaNV = /*new SelectList(db.NVs, "MaNV", "TenNV")*/tenNV;
                return View();
        }
        ...
        [HttpPost,ActionName("TạoTàiKhoản")]
